...
<nav
	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown no-arrow d-sm-none"><a
			...
			aria-expanded="false"> <i class="fas fa-search fa-fw text-white"></i>
		</a> <!-- Dropdown - Messages -->
			<div
		...
		<li class="nav-item dropdown no-arrow mx-1"><a
			...
			role="button" data-toggle="dropdown" aria-haspopup="true"
			aria-expanded="false"> <i class="fas fa-bell fa-fw text-white"></i>
				<!-- Counter - Alerts --> <span
		...
		<li class="nav-item dropdown no-arrow mx-1"><a
			...
			aria-expanded="false"> <i
				class="fas fa-envelope fa-fw text-white"></i> <!-- Counter - Messages -->
		...
		<li class="nav-item dropdown no-arrow"><a
			...
			aria-expanded="false"> <span
				class="mr-2 d-none d-lg-inline text-white small">${account.fullName}</span>
				<c:url value="/avatar" var="imgUrl">
					<c:param name="fname" value="${account.avatar}" />
				</c:url>
				<img class="img-profile rounded-circle mb-3" style="width:32px;height:32px;object-fit:cover;border:2px solid #007bff;"src="${imgUrl}">
		</a> <!-- Dropdown - User Information -->
			<div
				class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
				aria-labelledby="userDropdown">
				<a class="dropdown-item" href="${pageContext.request.contextPath}/admin/profile"> <i
