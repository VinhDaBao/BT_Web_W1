...
public class UserDaoImp implements UserDao{
	...
	@Override
	public User insert(String username, String password, String fullname, String avatar) {
		 String sql = "INSERT INTO [NguoiDung] (username, fullname, password, avatar) VALUES (?, ?, ?, ?)";
